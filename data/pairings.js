...
export const pairings = {
  "vitamin-d3": {
    pairWith: [
      { with: "Magnesium", slug: "magnesium", strength: "established",
      ...
      { with: "Dietary fat", slug: null, strength: "established",
      ...
      { with: "Vitamin K2", slug: null, strength: "plausible",
    ...
    keepApart: [
      { from: "Very high doses without monitoring", slug: null, strength: "caution",
  ...
  magnesium: {
    pairWith: [
      { with: "Divided doses", slug: null, strength: "established",
      ...
      { with: "Vitamin D3", slug: "vitamin-d3", strength: "established",
    ...
    keepApart: [
      { from: "Quinolone and tetracycline antibiotics", slug: null, strength: "caution",
      ...
      { from: "Bisphosphonates", slug: null, strength: "caution",
  ...
  iron: {
    pairWith: [
      { with: "Vitamin C", slug: "vitamin-c", strength: "established",
      ...
      { with: "Meat, poultry or seafood", slug: null, strength: "established",
    ...
    keepApart: [
      { from: "Calcium", slug: "calcium", strength: "caution",
      ...
      { from: "Tea and coffee", slug: null, strength: "caution",
      ...
      { from: "Zinc supplements", slug: "zinc", strength: "caution",
  ...
  zinc: {
    pairWith: [
      { with: "Animal-protein foods", slug: null, strength: "established",
      ...
      { with: "Copper, if supplementing long term", slug: "copper", strength: "established",
    ...
    keepApart: [
      ...
      { from: "Calcium supplements and high-phytate meals", slug: "calcium", strength: "caution",
  ...
  calcium: {
    pairWith: [
      ...
      { with: "Doses of 500 mg or less", slug: null, strength: "established",
    ...
    keepApart: [
      { from: "Levothyroxine", slug: null, strength: "caution",
      ...
      { from: "Iron and zinc supplements", slug: "iron", strength: "caution",
  ...
  copper: {
    pairWith: [
      { with: "A varied diet", slug: null, strength: "established",
    ...
    keepApart: [
      { from: "High-dose zinc", slug: "zinc", strength: "caution",
  ...
  "vitamin-c": {
    pairWith: [
      { with: "Plant iron sources", slug: "iron", strength: "established",
    ...
    keepApart: [
      { from: "Very large single doses", slug: null, strength: "caution",
  ...
  selenium: {
    pairWith: [
      { with: "Seafood twice a week", slug: null, strength: "established",
        why: P("A practical food route that also supplies iodine and omega-3s.",
               "طريق غذائي عملي يوفر أيضاً اليود وأوميغا-3.") },
    ],
    keepApart: [
      { from: "Stacking multiple selenium sources", slug: null, strength: "caution",
  ...
  creatine: {
    pairWith: [
      { with: "Daily consistency", slug: null, strength: "established",
  ...
  "collagen-peptides": {
    pairWith: [
      { with: "Adequate total protein", slug: null, strength: "established",
      ...
      { with: "Vitamin C", slug: "vitamin-c", strength: "plausible",
  ...
  probiotics: {
    pairWith: [
      { with: "Dietary fibre", slug: null, strength: "plausible",
    ...
    keepApart: [
      { from: "Assuming strains are interchangeable", slug: null, strength: "caution",
